...
export default function HoyuShikakuDetailPage() {
  ...
  return (
    <div>
      ...
      <div className="mt-6">
        <button onClick={() => navigate('/admin/hoyu-shikaku')} className="rounded-md bg-disabled px-5 py-1.5 text-xs font-bold text-white hover:brightness-95">
          一覧へ戻る
        </button>
      </div>
    </div>
